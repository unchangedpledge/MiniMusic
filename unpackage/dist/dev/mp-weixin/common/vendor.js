...
var _vuex = _interopRequireDefault(__webpack_require__(/*! vuex */ 138));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function ownKeys(object, enumerableOnly) {var keys = Object.keys(object);if (Object.getOwnPropertySymbols) {var symbols = Object.getOwnPropertySymbols(object);if (enumerableOnly) symbols = symbols.filter(function (sym) {return Object.getOwnPropertyDescriptor(object, sym).enumerable;});keys.push.apply(keys, symbols);}return keys;}function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};if (i % 2) {ownKeys(Object(source), true).forEach(function (key) {_defineProperty(target, key, source[key]);});} else if (Object.getOwnPropertyDescriptors) {Object.defineProperties(target, Object.getOwnPropertyDescriptors(source));} else {ownKeys(Object(source)).forEach(function (key) {Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));});}}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}
...
var store = new _vuex.default.Store({
  ...
  mutations: {
    changeTheme: function changeTheme(state, newTheme) {
      state.theme = 'theme' + newTheme;
    },
    showMiniPlayer: function showMiniPlayer(state) {
      state.mini = true;
    },
    setSongDetail: function setSongDetail(state, payload) {
      state.songDetail = payload;
    },
    updatePlaylist: function updatePlaylist(state, payload) {// 更新播放列表
      var loveList = uni.getStorageSync('loveList');
      var ids = loveList.map(function (item) {return item.id;});
      state.playlist = payload.map(function (item) {return _objectSpread(_objectSpread({}, item), {}, { isLove: ids.includes(item.id) });});
      console.log('store', loveList, state.playlist, payload.map(function (item) {return _objectSpread(_objectSpread({}, item), {}, { isLove: ids.includes(item.id) });}));
    },
    setCurIndex: function setCurIndex(state, payload) {// 更新当前下标
...
function playlist() {// 歌单
  return uni.request({
    url: "".concat(_config.baseUrl, "/playlist"),
    method: 'GET' });
...
list(_x) {return _list.apply(this, arguments);}function _list() {_list = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee(id) {var res1, res2;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:_context.next = 2;return (
              uni.request({
                url: "".concat(_config.baseUrl, "/playlist/detail?id=").concat(id),
                method: 'GET' }));case 2:res1 = _context.sent;

            console.log('res1', res1);if (!(
            res1[1].data.result.length == 0)) {_context.next = 11;break;}

            console.log('url', "http://localhost:3000/playlist/detail?id=".concat(id));_context.next = 8;return (
              uni.request({
                url: "http://localhost:3000/playlist/detail?id=".concat(id),
                method: 'GET' }));case 8:res2 = _context.sent;

            console.log('res2', res2);return _context.abrupt("return",
            res2);case 11:return _context.abrupt("return",

            res1);case 12:case "end":return _context.stop();}}}, _callee);}));return _list.apply(this, arguments);}function


songDetail(_x2) {return _songDetail.apply(this, arguments);}function _songDetail() {_songDetail = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee2(songId) {var res1, res2;return _regenerator.default.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:_context2.next = 2;return (
              uni.request({
                url: "".concat(_config.baseUrl, "/song/detail?songId=").concat(songId),
                method: 'GET' }));case 2:res1 = _context2.sent;if (!(


            res1[1].statusCode != 200)) {_context2.next = 8;break;}_context2.next = 6;return (

              uni.request({
                url: "http://localhost:3000/song/detail?ids=".concat(songId),
                method: 'GET' }));case 6:res2 = _context2.sent;return _context2.abrupt("return",
...
function songLyric(songId) {// 歌词
  return uni.request({
    url: "http://localhost:3000/lyric?id=".concat(songId),
    method: 'GET' });

}
// /song/url?id=33894312 歌曲链接
function songUrl(songId) {// 歌曲url
  return uni.request({
    url: "http://localhost:3000/song/url?id=".concat(songId),
    method: 'GET' });
